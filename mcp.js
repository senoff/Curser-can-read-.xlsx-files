...

  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sheet:      { type: 'string', description: 'Sheet name (default: first sheet).' },
        header_row: { type: 'integer', minimum: 0, description: 'Header row (1-based). 0 = treat row 1 as data, no header.' },
        limit:      { type: 'integer', minimum: 1, default: 1000, description: 'Max matching rows to return (default 1000).' },
      },
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sheet:      { type: 'string', description: 'Sheet name (default: first sheet).' },
        header_row: { type: 'integer', minimum: 0, description: 'Header row (1-based). 0 = treat row 1 as data, no header.' },
        sort:       { type: 'string', enum: ['asc', 'desc', 'none'], description: 'Sort groups by the first aggregation: asc / desc / none (default none).' },
        limit:      { type: 'integer', minimum: 1, default: 1000, description: 'Max groups to return (default 1000).' },
      },
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sheet:      { type: 'string', description: 'Sheet name (default: first sheet).' },
        header_row: { type: 'integer', minimum: 0, description: 'Header row (1-based). 0 = treat row 1 as data, no header.' },
        limit:      { type: 'integer', minimum: 1, default: 1000, description: 'Max rows to return (default 1000).' },
      },
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sheet:     { type: 'string', description: 'Sheet name (default: first sheet).' },
        header_row:    { type: 'integer', minimum: 0, description: 'Header row (1-based). 0 = treat row 1 as data, no header.' },
        top_n:         { type: 'integer', minimum: 1, default: 50, description: 'Show top N most-frequent values (default 50).' },
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit:     { type: 'integer', minimum: 1, default: 1000, maximum: 5000, description: 'Max formulas to return (default 1000, max 5000).' },
      },
      required: ['file_path'],
    },
  },
...
try {
  ...
  /* no generated floor present — hand-authored TOOLS remain the floor */
}
